...
Follow the model instructions. Continue from the history above. Be {agent_name}."""
    ...
    async def _stream_tts_chunk(self, text: str, use_ssml: bool = False, is_final: bool = False, prefetched_bytes: Optional[bytes] = None):
        """
        ...
        try:
            ...
            async with self._tts_lock:
                ...
                try:
                    ...
                    use_streaming_tts = word_count >= 4 and not _use_prefetched
