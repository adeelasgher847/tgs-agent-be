    ...
    *,
    ...
    if job:
        ...
        lines.append(
            ...
            "   If they only say \"busy right now\" but are willing to continue later — keep the call short and end with [END_CALL].\n\n"
            "4) ONLY IF STILL ON CALL AFTER STEPS 1-3 — role-specific screening (one question at a time):\n"
