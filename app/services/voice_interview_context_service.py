    ...
    *,
    ...
    if job:
        ...
        lines.append(
            ...
            "- SUCCESS CLOSING (when you will append [SCREENING_QUALIFIED]): thank them briefly, then say our **technical team** "
            "will **review** their screening answers and may **reach out for the next interview step** (or a technical interview). "
            "Do NOT say their profile will be moved to next-step review, do not promise a job offer, and do not invent a timeline unless the JD explicitly states one.\n"
