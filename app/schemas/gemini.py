...
class GeminiTestRequest(BaseModel):
    ...
    temperature: float | None = Field(0.7, ge=0.0, le=1.0, description="Temperature setting (0.0 to 1.0)")
    max_tokens: int | None = Field(1000, gt=0, le=8192, description="Maximum tokens for response")
